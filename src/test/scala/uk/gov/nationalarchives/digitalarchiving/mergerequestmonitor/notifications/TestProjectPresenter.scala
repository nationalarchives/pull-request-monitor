...
case class TestMergeRequestPresenter(authorName: String, title: String, url: String, daysSinceLastUpdate: Long, draft: String = "") extends MergeRequestSlackPresenter
