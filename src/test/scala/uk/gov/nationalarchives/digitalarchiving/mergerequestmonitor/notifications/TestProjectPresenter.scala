...
case class TestMergeRequestPresenter(authorName: String, title: String, url: String, daysSinceLastUpdate: Long, draft: String = "", reviewStatus: String = "", commentUsers: String = "", commentCount: String = "") extends MergeRequestSlackPresenter
